			...
			<div class="ec-content-wrapper">
				<div class="content">
					<div class="breadcrumb-wrapper breadcrumb-contacts">
						...
						<div>
						<a href="<?= _WEB_ROOT ?>/admin/customer?action=add" class="btn btn-primary"> Add Customer</a>
						</div>
					</div>
					<div class="row">
						<div class="col-12">
														...
														<td>
															<div class="btn-group mb-1">
																<button type="button" class="btn btn-outline-success">
																	<a href="<?php echo _WEB_ROOT . '/admin/customer?action=profile&id=' . $lc['Id'] ?>" style="text-decoration: none; color: #34c997;">Info</a>
																</button>
																...
																<div class="dropdown-menu">
																	...
																	<a class="dropdown-item" href="<?php echo _WEB_ROOT . '/Admin/DeleteCustomer?id=' . $lc['Id'] ?>">Delete</a>
																</div>
															</div>
														</td>
													</tr>
